...
cc.Class({
    ...
    checkCb: function (event) {
        ...
        switch (event.getEventCode())
        {
            ...
            case jsb.EventAssetsManager.NEW_VERSION_FOUND:
                this.tip.string = 'New version found, please try to update. (' + this._am.getTotalBytes() + ')';
    ...
    updateCb: function (event) {
        ...
        switch (event.getEventCode())
        {
            ...
            case jsb.EventAssetsManager.UPDATE_PROGRESSION:
                ...
                if (msg) {
                    this.tip.string = 'Updated file: ' + msg;
    ...
    checkUpdate: function () {
        if (this._updating) {
            this.tip.string = 'Checking or updating ...';
            return;
        }
        if (this._am.getState() === jsb.AssetsManager.State.UNINITED) {
            // Resolve md5 url
        ...
        if (!this._am.getLocalManifest() || !this._am.getLocalManifest().isLoaded()) {
            this.tip.string = 'Failed to load local manifest ...';
            return;
        }
    ...
    onLoad: function () {
        ...
        this.tip.string="更新"+this._storagePath;
